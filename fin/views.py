...
from .forms import CategoryGroupedCatUpdateAll, PayeeGroupedCatUpdateAll, AddPayee, Moving, Budget, AddTransaction, PayeeMergeForm, PayeeCategoryUpdate, PayeeAccountUpdate, AddTransactionAll, PayeeCategoryUpdateAll
...
class PayeeListView(ListView):
	...
	def get_queryset(self):
		a = self.request.GET.get('a', 'act')
		o = self.request.GET.get('o', 'payee')

		queryset = Payee.objects.annotate(
